package com.github.jiloc01.minesweeper;
...
class Minesweeper extends JFrame implements ActionListener, ContainerListener {
    ...
    public void setmanue() {
        ...
        final JCheckBoxMenuItem beginner = new JCheckBoxMenuItem("Новичек");
        ...
        final JCheckBoxMenuItem custom = new JCheckBoxMenuItem("Выбор сложности");
    ...
    public void winner() {
        ...
        if (q == 0) {
            ...
            sw.stop();
            JOptionPane.showMessageDialog(this, "Вы выигарли");
        }
    }
    ...
    public void dfs(int row, int col) {
        ...
        if (row >= 0 && row < blockr && col >= 0 && col < blockc ){
            blocks[row][col].setIcon(ic[13]);
        }
